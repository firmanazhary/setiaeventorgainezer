  ...
  return (
    <section className="relative pt-20 pb-24 px-6 bg-[#050505] overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto relative z-10 text-center">
        {/* JUDUL "BUAT ANDA" */}
        <h2 className="font-heading text-4xl md:text-5xl font-bold text-[#D4AF37] mb-12 uppercase tracking-widest drop-shadow-lg">BAGI ANDA:</h2>
        ...
        <div className="space-y-6 text-left inline-block">
          {[
            ...
            <div key={idx} className="flex items-start gap-4 group">
              ...
              <p className="text-white text-base md:text-xl font-light leading-snug group-hover:text-[#D4AF37] transition-colors">{item}</p>
            </div>
          ))}
        </div>
