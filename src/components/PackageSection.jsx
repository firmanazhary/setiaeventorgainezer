...
const packages = [
  {
    ...
    features: [
      "Berlaku Untuk Satu Pasangan Suami - Istri (Dua Orang)",
      "Buku Marriage Undercover atau Cita Cinta Setia",
      "2 Paket Chemistry Card",
      "Tempat Duduk VIP (Front Row)",
      "Foto bersama Setia Furqon Kholid"
    ]
  },
  {
    id: 'reg-couple',
  ...
  },
  {
    ...
    features: [
      ...
      "1 Paket Chemistry Card",
      "Tempat Duduk Single Regular"
    ]
  }
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          {packages.map((pkg, idx) => (
            <div 
              key={idx} 
              className="bg-white rounded-3xl overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 shadow-2xl"
            >
              ...
              <div className="p-8">
                 ...
                 <button 
                    ...
                    className={`w-full py-4 rounded-full text-white font-bold shadow-lg uppercase tracking-wide transform active:scale-95 transition-all ${pkg.buttonColor} hover:brightness-110`}
                 >
                    PILIH TIKET INI
                 </button>
              </div>
