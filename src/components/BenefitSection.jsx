    ...
    <section className="bg-[#050505] rounded-t-[3rem] md:rounded-t-[5rem] -mt-20 pt-20 pb-24 px-6 relative z-30 shadow-[0_-10px_60px_rgba(0,0,0,0.5)]">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 space-y-2">
            <h3 className="text-[#D4AF37] font-heading text-2xl md:text-3xl font-medium italic">
                InsyaAllah dalam seminar
            </h3>
        ...
        <div className="grid gap-6">
            {[
                "Cara agar suami makin lengket, tidak berpaling ke lain hati",
                ...
                "Cara mentreatmen cinta setelah menikah"
            ].map((item, idx) => (
                <div 
                    key={idx} 
                    className="flex items-start gap-4 p-2 md:p-3 group hover:translate-x-2 transition-transform duration-300"
                >
                    ...
                    <p className="text-gray-200 text-sm md:text-lg font-medium leading-snug group-hover:text-white transition-colors">
                        {item}
                    </p>
                </div>
            ))}
